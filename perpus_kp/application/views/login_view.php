...
<body class="hold-transition login-page" style="overflow-y: hidden;background:url(
	'<?php echo base_url('assets_style/image/sd1.jpg');?>')no-repeat;background-size:100%;">
<div class="login-box">
	<br/>
  <div class="login-logo">
    <a href="index.php" style="color: Black;"><h3><b>SISTEM INFORMASI PERPUSTAKAAN SD MUHAMMADIYAH 3 CILEDUG</b></h3></a>
  </div>
  ...
  <footer>
    <div class="login-box-body text-center bg-blue">
       <a style="color: White;"> Copyright &copy; SD Muhammadiyah 3 Ciledug <?php echo date("Y");?>
    </div>
  </footer>
</div>
<!-- /.login-box -->
